...
static void	set_wall_texture(t_cub3d *s_cub3d)
{
	...
	no_loaded_texture = s_cub3d->textures.loaded_textures.no_loaded_texture;
	so_loaded_texture = s_cub3d->textures.loaded_textures.so_loaded_texture;
	ea_loaded_texture = s_cub3d->textures.loaded_textures.ea_loaded_texture;
	we_loaded_texture = s_cub3d->textures.loaded_textures.we_loaded_texture;
	if (s_cub3d->rays.side_hit == NORTH_SOUTH && s_cub3d->rays.ray_dir_y < 0)
		s_cub3d->textures.wall_texture = no_loaded_texture;
	else if (s_cub3d->rays.side_hit == NORTH_SOUTH
		&& s_cub3d->rays.ray_dir_y > 0)
			s_cub3d->textures.wall_texture = so_loaded_texture;
	else if (s_cub3d->rays.side_hit == WEST_EAST && s_cub3d->rays.ray_dir_x > 0)
		s_cub3d->textures.wall_texture = ea_loaded_texture;
	else if (s_cub3d->rays.side_hit == WEST_EAST && s_cub3d->rays.ray_dir_x < 0)
		s_cub3d->textures.wall_texture = we_loaded_texture;
}
...
static void	set_texture_info(t_cub3d *s_cub3d)
{
	...
	s_cub3d->textures.texture_x = (int)(s_cub3d->textures.wall_hit_x
			* s_cub3d->textures.wall_texture->width);
