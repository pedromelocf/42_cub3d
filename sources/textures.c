...
void	draw_texturized_line(int x, t_cub3d *s_cub3d)
{
	...
	s_cub3d->textures.step = 1.0 * s_cub3d->textures.wall_texture->height / s_cub3d->rays.line_height;
	s_cub3d->textures.texture_x = (int)(s_cub3d->textures.wall_hit_x * (double)s_cub3d->textures.wall_texture->width);
	s_cub3d->textures.texture_pos = (s_cub3d->rays.draw_start - SCREEN_HEIGHT / 2 + s_cub3d->rays.line_height / 2) * s_cub3d->textures.step;
	s_cub3d->textures.texture_y = (int)s_cub3d->textures.texture_pos & (s_cub3d->textures.wall_texture->height - 1);
	int i = s_cub3d->rays.draw_start;
	while (i < s_cub3d->rays.draw_end)
	{
		s_cub3d->textures.texture_y = (int)s_cub3d->textures.texture_pos & (s_cub3d->textures.wall_texture->height - 1);
